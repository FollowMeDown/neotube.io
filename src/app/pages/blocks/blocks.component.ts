...
export class BlocksComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.aRouter.params.subscribe(params => {
            ...
            if (this.isNumberPattern.test(page)) {
                ...
                this.router.navigateByUrl('/blocks/page/1');
            }
        });
    ...
    getListData() {
        this.loading = true;
        this.apiService.GetBlocks(this.page.index, this.page.size).subscribe((res: any) => {
            if (res.code === 200) {
    ...
    onpageGo(num: number) {
        this.router.navigateByUrl(`/blocks/page/${num}`);
    }
}
