...
export class AddressesComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.aRouter.params.subscribe(params => {
            ...
            if (this.isNumberPattern.test(page)) {
                ...
                this.router.navigateByUrl('/addresses/page/1');
            }
        });
    ...
    getListData() {
        this.loading = true;
        this.apiService.GetAddresses(this.page.index, this.page.size).subscribe((res: any) => {
            if (res.code === 200) {
    ...
    onpageGo(num: number) {
        this.router.navigateByUrl(`/addresses/page/${num}`);
    }
}
